...
public class AnalysisDatasetApplication {
  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    meetupStream.foreachRDD((JavaRDD<ConsumerRecord<String, String>> meetupRDD) -> {
      ...
      ((CanCommitOffsets) meetupStream.inputDStream())
        .commitAsync(offsetRanges, new MeetupOffsetCommitCallback3());
    });
...
final class MeetupOffsetCommitCallback3 implements OffsetCommitCallback {
