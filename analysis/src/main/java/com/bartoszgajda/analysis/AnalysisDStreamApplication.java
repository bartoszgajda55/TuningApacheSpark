...
public class AnalysisDStreamApplication {
  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    meetupStream.foreachRDD((JavaRDD<ConsumerRecord<String, String>> meetupRDD) -> {
      ...
      ((CanCommitOffsets) meetupStream.inputDStream())
        .commitAsync(offsetRanges, new MeetupOffsetCommitCallback2());
    });
...
final class MeetupOffsetCommitCallback2 implements OffsetCommitCallback {

  private static final Logger log = Logger.getLogger(MeetupOffsetCommitCallback2.class.getName());
